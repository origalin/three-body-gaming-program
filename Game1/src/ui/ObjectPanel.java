...
public class ObjectPanel extends JLabel {
	...
	static String[] textContains = { "信息时代的开端，能极大地提高计算能力",
			"音乐、影像技术实现大的飞跃，能够提高创造力",
			"能够使运输方式实现革命性变化，提高运输效率",
			"能够极大地提高制造物品的精度，可以制造精密仪器",
			"新型材料，能够制质轻、耐用的物品",
			...
			"打开宇宙之门的钥匙，畅游太空的第一步，具有极强的续航能力，或许在它的帮助下我们能找到宇宙的尽头",
			"融合各种生物的优良特性，能上天能入地能下海，是你进入太空的钥匙",
			"将各种科技加入生物中，超越已知任何生物的极限，是生物科技的巅峰之作"
			  };
